...
│   ├── types/ [Типизация]<br>
│   │   ├── index.ts/ [Интерфейсы и некоторые типы]<br>
│   ├── utils/<br>
...
Для примера работы подхода взял событие клика по карточке товара, а дальше по клику на кнопку `Добавить в корзину`
